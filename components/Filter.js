...
async function onAddForm (price,placeList,grade,subjectList){
    ...
    return(
        <React.Fragment>
            <form>
            <ModalFilter listHandlerHandler={placeHandlerHandler} option={place} passValue={placeList} buttonName='Place'/>
            <ModalFilter listHandlerHandler={subjectHandlerHandler} option={subjects} passValue={subjectList}  buttonName='Subject'/>
